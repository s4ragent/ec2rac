...
Roles=(
"node c3.large 2 0.05 $PackageAmiId $HOME_DEVICE,$SWAP_DEVICE,$ORACLE_HOME_DEVICE"
"tinc c3.large 1 0.05 $PackageAmiId $HOME_DEVICE"
"storage c3.large 1 0.05 $PackageAmiId $HOME_DEVICE,$STORAGE_DEVICE"
)
...
case "$1" in
  ...
  "exerootsh" ) shift;exerootsh $*;;
  "getlogs" ) shift;getlogs $*;;
  "getfile" ) shift;getfile $*;;
  "watch" ) watch;;
  ...
  "setupdns" ) shift;setupdns $*;;
  "setnodelist" ) setnodelist;;
  "getnodelist" ) shift;getnodelist $*;;
  "createtincconf" ) shift;createtincconf $*;;
  "clone" ) shift;clone $*;;
  "startinstances" ) shift;startinstances $*;;
  "requestspotinstances" ) shift;requestspotinstances $*;;
   "addspotinstances" ) shift;addspotinstances $*;;
  ...
  "createdevicejson" ) shift;createdevicejson $*;;
  "test" ) test;;
  ...
  "createdbcaoption" ) shift;createdbcaoption $*;;
  "gettopic" ) shift;gettopic $*;;
  "publishtopic" ) shift;publishtopic $*;;
  "testtopic" ) shift;testtopic $*;;
